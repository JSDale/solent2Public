...
public interface FarmFacade {
    ...
    /**
     * Creates an Animal of a given AnimalType with a name and adds the animal to the list of animals stored by this farm.Note that more than one animal can be added with the same name
     ...
     */
    public Animal addAnimal(String animalType, String name, String food);
